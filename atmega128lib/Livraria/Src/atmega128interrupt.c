...
void INTERRUPT_set(uint8_t channel, uint8_t sense)
{
	switch( channel ){
		case 0: // PD0
			...
			atmega128()->exint_reg->eicra.reg &= ~((1 << ISC01) | (1 << ISC00));
			switch(sense){
				...
				case 2: // The falling edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= (1 << ISC01);
				break;
		...
		case 1: // PD1
			...
			atmega128()->exint_reg->eicra.reg &= ~((1 << ISC11) | (1 << ISC10));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				case 1: // The low level of INTn generates an interrupt request.
				break;
				case 2: // The falling edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= (1 << ISC11);
				break;
				case 3: // The rising edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= ((1 << ISC11) | (1 << ISC10));
				break;
		...
		case 2: // PD2
			...
			atmega128()->exint_reg->eicra.reg &= ~((1 << ISC21) | (1 << ISC20));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				case 1: // The low level of INTn generates an interrupt request.
				break;
				case 2: // The falling edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= (1 << ISC21);
				break;
				case 3: // The rising edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= ((1 << ISC21) | (1 << ISC20));
				break;
		...
		case 3: // PD3
			...
			atmega128()->exint_reg->eicra.reg &= ~((1 << ISC31) | (1 << ISC30));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				case 1: // The low level of INTn generates an interrupt request.
				break;
				case 2: // The falling edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= (1 << ISC31);
				break;
				case 3: // The rising edge of INTn generates asynchronously an interrupt request.
					atmega128()->exint_reg->eicra.reg |= ((1 << ISC31) | (1 << ISC30));
				break;
		...
		case 5: // PE5
			...
			atmega128()->exint_reg->eicrb.reg &= ~((1 << ISC51) | (1 << ISC50));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				break;
				case 1: // Any logical change on INTn generates an interrupt request
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC50);
				break;
				case 2: // The falling edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC51);
				break;
				case 3: // The rising edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= ((1 << ISC51) | (1 << ISC50));
				break;
		...
		case 6: // PE6
			...
			atmega128()->exint_reg->eicrb.reg &= ~((1 << ISC61) | (1 << ISC60));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				break;
				case 1: // Any logical change on INTn generates an interrupt request
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC60);
				break;
				case 2: // The falling edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC61);
				break;
				case 3: // The rising edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= ((1 << ISC61) | (1 << ISC60));
				break;
		...
		case 7: // PE7
			...
			atmega128()->exint_reg->eicrb.reg &= ~((1 << ISC71) | (1 << ISC70));
			switch(sense){
				case 0: // The low level of INTn generates an interrupt request.
				break;
				case 1: // Any logical change on INTn generates an interrupt request
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC70);
				break;
				case 2: // The falling edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= (1 << ISC71);
				break;
				case 3: // The rising edge between two samples of INTn generates an interrupt request.
					atmega128()->exint_reg->eicrb.reg |= ((1 << ISC71) | (1 << ISC70));
				break;
