...
/*** File Variable ***/
static TIMER_COUNTER1 atmega128_tc1;
...
// for more information read data sheet.
{
	...
	atmega128()->tc1_reg->ocr1a = atmega128()->writehlbyte(~0);
	atmega128()->tc1_reg->ocr1b = atmega128()->writehlbyte(~0);
	atmega128()->tc1_reg->ocr1c = atmega128()->writehlbyte(~0);
...
TIMER_COUNTER1* tc1(void){ return &atmega128_tc1; }
...
void TIMER_COUNTER1_compareA(uint16_t compare)
{
	atmega128()->tc1_reg->ocr1a = atmega128()->writehlbyte(compare);
}
void TIMER_COUNTER1_compareB(uint16_t compare)
{
	atmega128()->tc1_reg->ocr1b = atmega128()->writehlbyte(compare);
}
void TIMER_COUNTER1_compareC(uint16_t compare)
{
	atmega128()->tc1_reg->ocr1c = atmega128()->writehlbyte(compare);
}
uint8_t TIMER_COUNTER1_stop(void)
