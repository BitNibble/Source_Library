...
typedef struct {
	...
	Atmega32U4TimerMask_TypeDef* mask; // 0x6E
	Atmega32U4TimerInterruptFlag_TypeDef* flag; // 0x35
...
typedef struct {
	...
	Atmega32U4CompareRegister1_TypeDef* comp; // 0x88
	Atmega32U4TimerMask_TypeDef* mask; // 0x6E
	Atmega32U4TimerInterruptFlag_TypeDef* flag; // 0x35
...
typedef struct {
	...
	Atmega32U4CompareRegister3_TypeDef* comp; // 0x98
	Atmega32U4TimerMask_TypeDef* mask; // 0x6E
	Atmega32U4TimerInterruptFlag_TypeDef* flag; // 0x35
