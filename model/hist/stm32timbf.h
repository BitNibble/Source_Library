...
volatile typedef union{
	struct TIM_CR1_1{
		...
		uint32_t ckd:2;
		uint32_t fill:22;
	}tim_cr1_par,tim1and8_cr1_par,tim2to5_cr1_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_SMCR_1{
		...
		uint32_t etp:1;
		uint32_t fill2:16;
	}tim_smcr_par,tim1and8_smcr_par,tim2to5_smcr_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_DIER_1{
		...
		uint32_t tde:1;
		uint32_t fill:17;
	}tim_dier_par,tim1and8_dier_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_SR_1{
		...
		uint32_t cc4of:1;
		uint32_t fill2:19;
	}tim_sr_par,tim1and8_sr_par;
	struct TIM_SR_2{
		uint32_t iflag:8;
		uint32_t fill1:1;
		uint32_t oflag:4;
		uint32_t fill2:19;
	}tim_sr_iof_par,tim1and8_sr_iof_par;
	struct TIM_SR_3{
		uint32_t fill1:1;
		uint32_t cciflag:4;
		uint32_t fill2:4;
		uint32_t ccoflag:4;
		uint32_t fill3:19;
	}tim_sr_iocc_par,tim1and8_sr_iocc_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_CCMR1_1{
		...
		uint32_t oc2ce:1;
		uint32_t fill:16;
	}tim_ccmr1_ocm_par,tim1an8_ccmr1_ocm_par,tim2to5_ccmr1_ocm_par;
	struct TIM_CCMR1_2{
		uint32_t cc1s:2;
		uint32_t ic1psc:2;
		uint32_t ic1f:4;
		...
		uint32_t ic2f:4;
		uint32_t fill:16;
	}tim_ccmr1_icm_par,tim1and8_ccmr1_icm_par,tim2to5_ccmr1_icm_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_CCMR1_5{
		...
		uint32_t oc1m:3;
		uint32_t fill:25;
	}tim10and11_ccmr1_ocm_par;
	struct TIM_CCMR1_6{
		uint32_t cc1s:2;
		uint32_t ic1psc:2;
		uint32_t ic1f:4;
		uint32_t fill:24;
	}tim10and11_ccmr1_icm_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_CCMR2_1{
		...
		uint32_t oc4ce:1;
		uint32_t fill:16;
	}tim_ccmr2_ocm_par,tim1and8_ccmr2_ocm_par,tim2to5_ccmr2_ocm_par;
	struct TIM_CCMR2_2{
		uint32_t cc3s:2;
		uint32_t ic3psc:2;
		uint32_t ic3f:4;
		...
		uint32_t ic4f:4;
		uint32_t fill:16;
	}tim_ccmr2_icm_par,tim1and8_ccmr2_icm_par,tim2to5_ccmr2_icm_par;
	uint32_t dword;
...
volatile typedef union{
	struct TIM_DCR_1{
		...
		uint32_t dbl:5;
		uint32_t fill2:19;
	}tim_dcr_par,tim1an8_dcr_par,tim2to5_dcr_par;
	uint32_t dword;
